...
class Gun:
    ...
    def draw(self):
        self.color_now = (
        255 - (self.f2_power - 1) / 24 * (255 - self.color[0]), 255 - (self.f2_power - 1) / 24 * (255 - self.color[1]),
        255 - (self.f2_power - 1) / 24 * (255 - self.color[2]))
        pygame.draw.polygon(self.screen, self.color_now, ((self.x + 20 * math.cos(self.an) - 10 * math.sin(self.an),
                                                           self.y + 20 * math.sin(self.an) + 10 * math.cos(self.an)),
                                                          (self.x + 20 * math.cos(self.an) + 10 * math.sin(self.an),
                                                           self.y + 20 * math.sin(self.an) - 10 * math.cos(self.an)),
                                                          (self.x - 20 * math.cos(self.an) + 10 * math.sin(self.an),
                                                           self.y - 20 * math.sin(self.an) - 10 * math.cos(self.an)),
                                                          (self.x - 20 * math.cos(self.an) - 10 * math.sin(self.an),
                                                           self.y - 20 * math.sin(self.an) + 10 * math.cos(self.an))))
        pygame.draw.polygon(self.screen, (102, 102, 0), (
        (self.x - 40, self.y), (self.x + 40, self.y), (self.x + 40, self.y + 25), (self.x - 40, self.y + 25)))
